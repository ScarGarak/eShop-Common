...
public interface ShopInterface {
	...
	*/
	...
	public abstract String gibBestandsHistorie(int artikelnumme) throws IOException;
	
	public abstract int[] gibBestandsHistorieDaten(int artikelnummer) throws IOException;
